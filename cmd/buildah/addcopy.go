...
func init() {
  ...
  buildah copy containerID '/myapp/app.conf' '/myapp/app.conf'`,
	...
	addFlags.StringVar(&addOpts.chmod, "chmod", "", "set permissions of the destination content")
	...
	copyFlags.StringVar(&copyOpts.chmod, "chmod", "", "set permissions of the destination content")
